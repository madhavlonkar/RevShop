                            ...
                            <div class="product-line-grid row justify-content-between">
                                ...
                                <div class="product-line-grid-body col-md-6">
                                    ...
                                    <div class="product-line-info product-price">
                                        <span class="value">RS <%= String.format("%.2f", priceAfterDiscount) %></span>
                                    </div>
                                    <div class="product-line-info">
                                            ...
                                            <div class="quantity">
                                                <form action="CartUpdateServlet" method="post">
                                                    ...
                                                    <span class="input-group-btn-vertical">
                                                        <button class="btn btn-touchspin js-touchspin bootstrap-touchspin-up" type="submit" name="action" value="increase">
                                                            +
                                                        </button>
                                                        <button class="btn btn-touchspin js-touchspin bootstrap-touchspin-down" type="submit" name="action" value="decrease">
                                                            -
                                                        </button>
                                                    </span>
                                                </form>
