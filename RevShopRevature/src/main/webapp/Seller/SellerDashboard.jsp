                            ...
                            <ul class="menu-top navbar-nav">
                                ...
                                <li><a href="categories.html" class="parent">Categories</a>
                                    <div class="dropdown-menu">
                                        <ul>
                                            <li class="item"><a href="ProductMaintenanceServlet?category=Electronics" title="Electronics">Electronics</a></li>
                                            <li class="item"><a href="ProductMaintenanceServlet?category=Fashion" title="Fashion">Fashion</a></li>
                                            <li class="item"><a href="ProductMaintenanceServlet?category=Home Appliances" title="Home Appliances">Home Appliances</a></li>
                                            <li class="item"><a href="ProductMaintenanceServlet?category=Books" title="Books">Books</a></li>
                                            <li class="item"><a href="ProductMaintenanceServlet?category=Sports" title="Sports">Sports</a></li>
                                        </ul>
                                    </div>
                                </li>
                    ...
                    <div class="col-sm-5 col-md-5 d-flex align-items-center justify-content-end" id="search_widget">
                        <div id="block_myaccount_infos" class="hidden-sm-down dropdown">
                            <div class="myaccount-title">
                                <a href="#account" data-toggle="collapse" class="account">
                            ...
                            <div id="account" class="collapse">
                                <div class="account-list-content">
                                    <div>
                                        <a class="login" href="user-account.html" rel="nofollow" title="Log in to your customer account">
                                            <i class="fa fa-cog"></i>
                        ...
                        <div class="sidebar-block">
                            ...
                            <div class="block-content">
                                <div class="cateTitle hasSubCategory open level1">
                                    <a class="cateItem" href="ProductMaintenanceServlet?category=Electronics">Electronics</a>
                                </div>
                                <div class="cateTitle hasSubCategory open level1">
                                    <a class="cateItem" href="ProductMaintenanceServlet?category=Fashion">Fashion</a>
                                </div>
                                <div class="cateTitle hasSubCategory open level1">
                                    <a class="cateItem" href="ProductMaintenanceServlet?category=Home Appliances">Home Appliances</a>
                                </div>
                                <div class="cateTitle hasSubCategory open level1">
                                    <a class="cateItem" href="ProductMaintenanceServlet?category=Books">Books</a>
                                </div>
                                <div class="cateTitle hasSubCategory open level1">
                                    <a class="cateItem" href="ProductMaintenanceServlet?category=Sports">Sports</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="nov-html col-lg-4 col-sm-12 col-xs-12">
                            <div class="block">
                                <div class="block-content">
                                    ...
                                    <p class="content-logo">Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="block-content">
                                    <div class="payment-content">
                                        ...
                                        <div class="payment-image">
                                            <img class="img-fluid" src="Static/img/home/payment.png" alt="img">
                                        </div>
                                    </div>
                                </div>
                            </div>
