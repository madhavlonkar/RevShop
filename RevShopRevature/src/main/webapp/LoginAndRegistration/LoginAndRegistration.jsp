...
.input-group input, .input-group select {
	/* This applies the same styling to both input and select elements */
	width: 100%;
	padding: 1rem 3rem;
	font-size: 1rem;
...
.input-group input:focus, .input-group select:focus {
	/* Ensure select has focus styling */
...
<body>
			...
			<div class="col align-items-center flex-col sign-up">
				<div class="form-wrapper align-items-center">
					<div class="form sign-up">
						...
						<form action="/RevShopRevature/RegistrationServlet" method="POST">
							<div class="input-group">
								<i class='bx bxs-user'></i> <select name="userType"
			...
			<div class="col align-items-center flex-col sign-in">
				<div class="form-wrapper align-items-center">
					<div class="form sign-in">
						...
						<form action="/RevShopRevature/LoginServlet" method="POST">
							<div class="input-group">
								<i class='bx bxs-user'></i> <input type="text" name="username"
    ...
    let section = '<%=request.getAttribute("section") != null ? request.getAttribute("section") : "sign-in"%>';
